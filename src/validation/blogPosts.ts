...
import { imageFileSchema, objectIdSchema } from "../utils/validations";
...
export type GetBlogPostsQuery = yup.InferType<
  typeof getBlogPostsSchema
>["query"];
...
export type UpodateBlogPostParams = yup.InferType<
